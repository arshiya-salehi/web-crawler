...
_TRAP_KEYWORDS = (
    ...
    # DokuWiki / wiki UI noise and file browser/query parameters
    "do=", "idx=", "ns=", "tab=", "tab_files=", "media=", "doku.php", "lib/exe/", "fetch.php"
)
...
def is_valid(url):
    ...
    try:
        ...
        # 4) Site-specific: avoid DokuWiki UI endpoints on wiki.ics.uci.edu
        if netloc.endswith("wiki.ics.uci.edu"):
            if "doku.php" in path_lower or "lib/exe/" in path_lower or "fetch.php" in path_lower:
                return False
            if any(k in query for k in ("do=", "ns=", "idx=", "tab=", "tab_files=", "media=")):
                return False
